...
def change_steps(account, user_id, app_token, steps):
    ...
    seconds = int(int(sec_timestamp) / 1000)
...
if __name__ == "__main__":
    ...
    DefaultRandomMin = 10000
    DefaultRandomMax = 11000
